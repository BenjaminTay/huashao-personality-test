...
function ActScreen({ act, observerLog, onContinue, onHome }: { act: (typeof ACTS)[number]; observerLog: string | null; onContinue: () => void; onHome: () => void }) {
  return (

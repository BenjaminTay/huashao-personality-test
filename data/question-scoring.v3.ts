...
export const QUESTION_SCORING_V3: Record<string, QuestionScoring> = {
  ...
  Q05: { questionId: "Q05", dimensions: ["D", "I"], options: { A: { D: 5, I: 1 }, B: { D: 3, I: 2 }, C: { D: 2, I: 4 }, D: { D: 1, I: 5 } } },
  Q06: { questionId: "Q06", dimensions: ["R", "S"], options: { A: { R: 5, S: 2 }, B: { R: 2, S: 2 }, C: { R: 3, S: 4 }, D: { R: 3, S: 5 } } },
  Q07: { questionId: "Q07", dimensions: ["S", "I"], options: { A: { S: 1, I: 1 }, B: { S: 4, I: 2 }, C: { S: 4, I: 2 }, D: { S: 5, I: 5 } } },
  ...
  Q12: { questionId: "Q12", dimensions: ["S", "R"], options: { A: { S: 1, R: 1 }, B: { S: 5, R: 3 }, C: { S: 4, R: 5 }, D: { S: 2, R: 2 } } },
  ...
  Q17: { questionId: "Q17", dimensions: ["R", "B"], options: { A: { R: 5, B: 2 }, B: { R: 4, B: 4 }, C: { R: 4, B: 5 }, D: { R: 1, B: 5 } } },
  ...
  Q20: { questionId: "Q20", dimensions: ["R", "D"], options: { A: { R: 5, D: 5 }, B: { R: 3, D: 2 }, C: { R: 1, D: 1 }, D: { R: 2, D: 1 } } },
